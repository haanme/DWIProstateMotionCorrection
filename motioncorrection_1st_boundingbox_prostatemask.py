...
if __name__ == "__main__":
    ...
    for ROIfolder in ROIfolders:
        ...
        bounds = get_boundsmask_from_DICOM(dwishape, ROIpixel_array_all, ROInames, 20)
    ...
    try:
        conv.multidicom2multidicom(subvol_dirs, 'Noncorrected', experiment_dir, args.subject)
    except Exception as inst:
        errors = errors + 1
        print type(inst)     # the exception instance
        print inst.args      # arguments stored in .args
